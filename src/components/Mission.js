      ...
      <div className="about-container">
        <div className="about-text">
          ...
          <div className="about-cta">
            <a href= "#join">
              <button aria-label="Join Durba Foundation and support our heritage" className="btn btn-lg btn-primary">
                Join Us !
              </button>
            </a>
            <a href= "#events">
              <button className="btn btn-lg btn-outline" aria-label="View our upcoming events">Checkout our events for this year</button>
            </a>
          </div>
        </div>
